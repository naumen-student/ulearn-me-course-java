...
public class Point {
    ...
    public double getLength(Point point) {
        double lengthOfXProjection = x - point.getX();
        double lengthOfYProjection = y - point.getY();
        return Math.sqrt(lengthOfXProjection * lengthOfXProjection + lengthOfYProjection * lengthOfYProjection);
    }
