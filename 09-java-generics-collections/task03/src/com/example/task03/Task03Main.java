...
public class Task03Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        List<Set<String>> anagrams = findAnagrams(new FileInputStream("C:\\Users\\User\\Ulearn\\ulearn-me-course-java\\09-java-generics-collections\\task03\\resources\\singular.txt"), Charset.forName("windows-1251"));
